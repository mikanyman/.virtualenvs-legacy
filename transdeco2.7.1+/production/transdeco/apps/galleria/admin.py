...
from transdeco.apps.galleria.models import Site, Artist, Photographer, Work, Image, TechniqueType
...
class ArtistAdmin(admin.ModelAdmin):
    list_display = ('person_name', 'act_pass', 'new_work')
    fieldsets = [
        (None, {'fields': ['person_name', 'label', 'birth_date', 'descriptive_note', 'act_pass', 'new_work']}),
...
class WorkAdmin(admin.ModelAdmin):
    list_display = ('title_text', 'artist', 'item_number', 'mater_tech_descr', 'creation_date', 'edition_size', 'dimensions_description', 'price', 'items_in_store', 'new_work', 'order')
    list_filter = ['artist']
