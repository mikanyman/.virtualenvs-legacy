...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Person.gurardiansmobile'
        db.delete_column('etreg_person', 'gurardiansmobile')

        # Adding field 'Person.flightarrlocation'
        db.add_column('etreg_person', 'flightarrlocation', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'Person.guardiansmobile'
        db.add_column('etreg_person', 'guardiansmobile', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Person.gurardiansmobile'
        db.add_column('etreg_person', 'gurardiansmobile', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Deleting field 'Person.flightarrlocation'
        db.delete_column('etreg_person', 'flightarrlocation')

        # Deleting field 'Person.guardiansmobile'
        db.delete_column('etreg_person', 'guardiansmobile')
