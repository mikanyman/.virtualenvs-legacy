...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.height'
        db.alter_column('etreg_person', 'height', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Person.postalcode'
        db.alter_column('etreg_person', 'postalcode', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'Person.height'
        db.alter_column('etreg_person', 'height', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Person.postalcode'
        db.alter_column('etreg_person', 'postalcode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        'etreg.person': {
            ...
            'gurardiansmobile': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
