...
LOCAL_DEPLOYMENT = 'staging'

# ---------- roots ----------
VIRTUALENVS_ROOT = '/home/mnyman/.virtualenvs'
PROJECT_ROOT = '/home/mnyman/.virtualenvs/tallsmall/staging/tallsmall'
URL_ROOT = 'http://a199.myrootshell.com:8080/tallsmall/staging'
...
LOCAL_FIXTURE_DIRS = (
   VIRTUALENVS_ROOT + "/tallsmall/staging/tallsmall/apps/etreg/fixtures/",
)
...
LOCAL_INSTALLED_APPS = (
    ...
    # ---------- apps ----------
    'tallsmall.account',
    'tallsmall.apps.etreg',
    'tallsmall.apps.ipaccess',
    'tallsmall.apps.rules', # http://www.grenadepod.com/2009/11/09/how-to-use-generic-views-in-django/
