...
urlpatterns = patterns('',
    ...
    url(r'^create/$', 'apps.etreg.views.person_create', name='person-create'),
    url(r'^update/(?P<object_id>\d+)/$', 'apps.etreg.views.person_update', name='person-update'),
    url(r'^detail/(?P<object_id>\d+)/$', 'apps.etreg.views.person_detail', name='person-detail'),
    url(r'^list/$', 'apps.etreg.views.person_list', name="person-list"),
    url(r'^delete/(?P<object_id>\d+)/$', 'apps.etreg.views.person_delete', name='person-delete'),

    #url(r'^email/(?P<object_id>\d+)/$', list_detail.object_detail, person_email, name="person-email"),
    url(r'^email/(?P<object_id>\d+)/$', 'apps.etreg.views.send_email', name="person-email"),
