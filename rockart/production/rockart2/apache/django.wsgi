...
import site
site.addsitedir('/home/mnyman/.virtualenvs/rockart/lib/python2.7/site-packages')
...
if PWD.endswith('staging/rockart/apache'):
    sys.path.append('/home/mnyman/.virtualenvs/rockart/staging')
if PWD.endswith('production/rockart/apache'):
    sys.path.append('/home/mnyman/.virtualenvs/rockart/production')
os.environ['DJANGO_SETTINGS_MODULE'] = 'rockart.settings'
