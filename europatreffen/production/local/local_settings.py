...
PROJECT_ROOT = '/home/mnyman/.virtualenvs/europatreffen/%s/europatreffen' % LOCAL_DEPLOYMENT
URL_ROOT = 'http://a199.myrootshell.com:8080/europatreffen/%s' %  LOCAL_DEPLOYMENT
...
# ---------- databases ----------
#LOCAL_DATABASE_ROUTERS = ['europatreffen.routers.DatabaseAppsRouter']
LOCAL_DATABASES = {
    'default': {
...
LOCAL_FIXTURE_DIRS = (
   VIRTUALENVS_ROOT + "/europatreffen/production/europatreffen/apps/etreg/fixtures/",
)
...
LOCAL_INSTALLED_APPS = (
    ...
    # ---------- europatreffen.apps ----------
    'europatreffen.account',
    'europatreffen.apps.etreg',
    'europatreffen.apps.rules',
