...
#PROJECT_ROOT = abspath(os.path.dirname(__file__)) # C:\cygwin\home\mnyman\.virtualenvs\europatreffen\development\europatreffen
#USERENA_MODULE_PATH = abspath(PROJECT_ROOT, '..') # C:\cygwin\home\mnyman\.virtualenvs\europatreffen\development
...
MIDDLEWARE_CLASSES = (
    ...
    #'europatreffen.apps.ipaccess.middleware.IPAccessMiddleware', # ipaccess
...
ROOT_URLCONF = 'europatreffen.urls'

TEMPLATE_CONTEXT_PROCESSORS = {
    #'django.core.context_processors.auth', # replaced by "django.contrib.auth.context_processors.auth" below
    ...
    'europatreffen.context_processors.gen_view',
}
