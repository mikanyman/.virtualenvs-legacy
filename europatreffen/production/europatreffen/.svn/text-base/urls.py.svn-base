...
import os
from europatreffen.redirects import REDIRECTS
...
urlpatterns += patterns('',
    ...
    url(r'^rules/', include('europatreffen.apps.rules.urls')),
    
    # Examples:
    # url(r'^$', 'europatreffen.views.home', name='home'),
    url(r'^etreg/', include('europatreffen.apps.etreg.urls')),
