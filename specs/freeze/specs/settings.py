...
MEDIA_ROOT = '/home/mnyman/.virtualenvs/specs/freeze/specs/media/'

# URL that handles the media served from MEDIA_ROOT.
# Example: "http://media.lawrence.com"
#MEDIA_URL = 'http://www.tallsmall.fi:8080/site_media'
MEDIA_URL = 'http://www.tallsmall.fi/media/'

# URL prefix for admin media -- CSS, JavaScript and images. Make sure to use a
# trailing slash.
# Examples: "http://foo.com/media/", "/media/".
ADMIN_MEDIA_PREFIX = 'http://www.tallsmall.fi/admin_media/'


# ---------- static ----------
STATIC_ROOT = os.path.join(PROJECT_PATH, 'sitestatic')
STATIC_URL = 'http://www.tallsmall.fi/static/'
STATICFILES_DIRS = (
...
TEMPLATE_DIRS = (
    ...
    '/home/mnyman/.virtualenvs/specs/freeze/specs/templates',
)

#ALLOWED_INCLUDE_ROOTS = ('/home/mnyman/.virtualenvs/specs/freeze/specs/templates/ssi', '/var/www')
ALLOWED_INCLUDE_ROOTS = (
    '/home/mnyman/.virtualenvs/specs/freeze/specs/templates/include',
    '/home/mnyman/.virtualenvs/specs/freeze/specs/templates/html/koputuksia/',
    '/home/mnyman/.virtualenvs/specs/freeze/specs/templates/cells/common',
)
