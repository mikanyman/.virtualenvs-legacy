...
DATABASES = {
    'default': {
        ...
        'NAME': 'talls.sqlite',                 # Or path to database file if using sqlite3.
...
SECRET_KEY = 'xyke$+m@69os35a*q=zaj3csy&lx*t5&+89#72=*twy&#9#ls('
...
ROOT_URLCONF = 'talls.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'talls.wsgi.application'
