...
import site
site.addsitedir('/home/mnyman/.virtualenvs/callowaydemo/lib/python2.7/site-packages')
...
sys.path.append('/home/mnyman/.virtualenvs/callowaydemo/staging')
os.environ['DJANGO_SETTINGS_MODULE'] = 'callowaydemo.settings'
