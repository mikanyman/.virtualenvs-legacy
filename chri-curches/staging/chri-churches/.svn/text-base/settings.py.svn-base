...
if os.name == 'nt':
    ...
    URL_ROOT = 'http://art.jyu.fi:8080/churches/staging'
if os.name == 'posix':
    VIRTUALENVS_ROOT = '/opt/.virtualenvs'
    PROJECT_ROOT = '/opt/.virtualenvs/churches/staging/churches'
    URL_ROOT = 'http://art.jyu.fi:8080/churches/staging'
...
if os.name == 'posix':
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': '/opt/.virtualenvs/churches/sqlite/churches.sqlite',
        }
    }
...
if os.name == 'posix':
    TEMPLATE_DIRS = (
        '/opt/.virtualenvs/churches/staging/churches/templates'
    )
