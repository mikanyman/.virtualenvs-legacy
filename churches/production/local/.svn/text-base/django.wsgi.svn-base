...
ALLDIRS = ['/home/mnyman/.virtualenvs/churches/lib/python2.7/site-packages']
...
sys.path.append('/home/mnyman/.virtualenvs/churches/production')
os.environ['DJANGO_SETTINGS_MODULE'] = 'churches.settings'
