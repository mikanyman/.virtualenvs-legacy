...
activate_this = os.path.join(root, '/home/mnyman/.virtualenvs/maisemapaikka/bin/activate_this.py')
execfile(activate_this, dict(__file__=activate_this))

sys.path.append('/home/mnyman/.virtualenvs/maisemapaikka/staging')
os.environ['DJANGO_SETTINGS_MODULE'] = 'maisemapaikka.settings'
...
#import site
#site.addsitedir('/home/mnyman/.virtualenvs/maisemapaikka/lib/python2.7/site-packages')
