...
urlpatterns = patterns('',
    ...
    (r'rockart/research/lhtml/(?P<lhtml_dir>.*)/(?P<lhtml_file>.*)$', 'maisemapaikka.apps.portal.views.rockart_lhtml'),
    (r'rockart/story/$', 'maisemapaikka.apps.portal.views.rockart_story'),

    # MINUN PAIKKANI / MYLOCATION
    (r'mylocation/frontpg/$', 'maisemapaikka.apps.portal.views.mylocation_frontpg'),
    (r'mylocation/edit$', 'maisemapaikka.apps.geomaps.views.edit'),
)
...
if os.name == 'posix':
    urlpatterns += patterns('',
        ...
        (r'mylocation/map/', 'maisemapaikka.apps.geomaps.views.index'),
    )
